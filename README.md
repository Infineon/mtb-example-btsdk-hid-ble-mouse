...
1. Plug in the AIROC&#8482; board or mouse HW into your computer
...
4. Unplug the EVAL board or the mouse HW from your computer (i.e. unplug the UART cable).
5. Power cycle the EVAL board or the mouse HW.
6. Press the User button to start LE advertising, then pair with a PC or Tablet.
7. Once connected, it becomes the mouse of the PC or Tablet.

In case what you have is only the AIROC&#8482; EVAL board, you can reset the device while pressing and holding the User button. The device will enter Discovery mode. Once the device is in Discovery mode for pairing, you can release the User button.
