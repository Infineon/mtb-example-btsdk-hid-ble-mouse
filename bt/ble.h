...
typedef enum {
    BLE_RPT_INDX_BOOT,                   // 0
    BLE_RPT_INDX_BATTERY,                // 1
    BLE_RPT_INDX_MOUSE,                  // 2
    BLE_RPT_INDX_STDKEY,                 // 3
    BLE_RPT_INDX_MAX
...
#define APP_CLIENT_CONFIG_NOTIF_BOOT_RPT             (1<<BLE_RPT_INDX_BOOT)         // 0x001
#define APP_CLIENT_CONFIG_NOTIF_BATTERY_RPT          (1<<BLE_RPT_INDX_BATTERY)      // 0x002
#define APP_CLIENT_CONFIG_NOTIF_MOUSE_RPT            (1<<BLE_RPT_INDX_MOUSE)        // 0x004
#define APP_CLIENT_CONFIG_NOTIF_STDKEY_RPT           (1<<BLE_RPT_INDX_STDKEY)       // 0x008
